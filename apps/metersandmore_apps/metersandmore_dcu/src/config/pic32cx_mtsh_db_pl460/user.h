...
#define BLINK_LED_On()           BSP_RED_LED_PD17_On()
#define BLINK_LED_Off()          BSP_RED_LED_PD17_Off()
#define BLINK_LED_Toggle()       BSP_RED_LED_PD17_Toggle()

/* Macros for PLC Indication LED */
#define PLC_IND_LED_On()         BSP_RED_LED_PD18_On()
#define PLC_IND_LED_Off()        BSP_RED_LED_PD18_Off()
#define PLC_IND_LED_Toggle()     BSP_RED_LED_PD18_Toggle()
